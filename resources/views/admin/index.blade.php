...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="index.html"><i class="zmdi zmdi-home"></i><span>{{__('header.dashboad')}}</span></a></li>
            <li><a href="{{url('admin/user')}}"><i class="zmdi zmdi-account"></i><span>User</span></a></li>
            <li><a href="{{url('admin/post')}}"><i class="zmdi zmdi-account"></i><span>Post</span></a></li>
            <li><a href="{{route('category.index')}}"><i class="zmdi zmdi-account"></i><span>Category</span></a></li>
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>{{__('header.dashboard', ['name' => auth()->user()->name])}}</h2>
                <p>{{trans_choice('header.item', 2)}}</p>
                <ul class="breadcrumb">
