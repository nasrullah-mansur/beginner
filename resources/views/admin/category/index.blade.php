    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-item-center">
            <strong class="card-title m-0">Data Table</strong>
              ...
              <a href="{{route('category.create')}}" type="button" class="btn btn-primary float-right" >Add Category</a>
  ...
  <table id="tbody" class="table table-striped table-bordered">
    ...
    <tbody id="tbody">
      ...
      <tr class="mt">
        ...
        <td width="18%">
            <a href="{{route('category.edit', $cat->name)}}" type="button" class="btn btn-primary save">Edit</a>
